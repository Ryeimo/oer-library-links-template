...
Open Educational Resources (OER) was coined in 2001 for an open source approach to academic books and textbooks. Much like Free/Libre Open Source Software (FLOSS) developed its online programming culture around open licenses like GNU Public License (GPL) and copyleft, the hope was to apply similar open licenses for artworks (like Creative Commons's CC-BY-SA license) in hopes of developing a robust online library culture around free books. And just as open source software has succeeded in taking over the programming world, OER is now incrementally taking over the DIY publishing world, with hundreds of new OER textbooks being written and digitally published (for a free download) each year, forever in the public domain for sharing and reading by anyone in the world with an internet connection.
